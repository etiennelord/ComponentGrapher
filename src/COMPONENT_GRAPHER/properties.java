...
public class properties extends Properties implements Comparable {
   ...
   ////////////////////////////////////////////////////////////////////////////
    ...
    try {
      ...
      System.out.println("Error in loading properties from filename "+filename);
        return false;}
    return true;
    }
    ...
    try {
        ...
        BufferedWriter bw=new BufferedWriter(new FileWriter(new File(filename)));
            ...
            store0(bw, "properties", false);
            //super.store(bw, config.get("applicationName")+" "+config.get("version")+" (c) "+config.get("authorArmadillo"));
        bw.flush();
        bw.close();
        } catch(Exception e) {
            if (debug) e.printStackTrace();
            System.out.println("Error in saving properties from filename "+filename);
            return false;
        }
...
public static Object newObject(String ClassName) {
    ...
    return T;
        ...
        System.out.println("Unable to find "+ClassName);
        return null;}
