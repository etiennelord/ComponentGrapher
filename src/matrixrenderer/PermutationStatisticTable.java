...
public class PermutationStatisticTable extends JTable
	implements ChangeListener,PropertyChangeListener, TableModelListener
{
	private JTable main;
        private CharEditorTableModel tm;
        private static ImageIcon icon;
        
	public PermutationStatisticTable(JTable table)
	{
		if (icon==null) {
		...
		main.getModel().addTableModelListener( this );
                ...
                tm=(CharEditorTableModel)main.getModel();
		setFocusable( true );
